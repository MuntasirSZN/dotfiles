return {
	...
	opts = {
		{
			-- Set to ueberzug to use ueberzugpp instead of kitty graphics protocol, needs to install ueberzugpp
			backend = "kitty",
			-- set to magick_rock to use magick luarocks, needs luarocks setup (rocks will be built by lazy on installation)
			processor = "magick_rock", -- default
			kitty_method = "normal",
			integrations = {
